   ...
   <?php
      $faqList = [
         ...
         "2nd question" => [
            ...
            <p>Puoi leggere ulteriori informazioni sulla sicurezza online, incluso come proteggere te e la tua famiglia online, nel <a href='https://safety.google/' class='text-primary'>Centro Google per la sicurezza online</a>.</p>
            
            <p><a href='https://safety.google/' class='text-primary'>Scopri</a> quali misure adottiamo per garantire protezione e sicurezza alle tue informazioni personali, lasciando a te il controllo.</p>"
         ],
         "3rd question" => [
